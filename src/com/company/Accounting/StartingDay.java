    ...
    public void checkingNewday() {
        ...
        if (flag) { // if is a date into today.json file
            ...
            if (today.equals(dateInFile)) { // same date
                try {
                    System.out.println(
                            "Hubo un cierre no programado del sistema. Por favor ingrese el monto actual en caja: ");
                ...
                Accounting.expensesToPayOrAddingInCurrentAccountFile(Accounting.getCash() - 5000, 2); // send amount in
                                                                                                      // cash (-5000$)
                                                                                                      // to current
                                                                                                      // account array
                                                                                                      // file
                ...
                if (today.substring(5, today.length() - 3).equals(dateInFile.substring(5, dateInFile.length() - 3))) { /// the
                                                                                                                       /// month
                                                                                                                       /// changes

                    double totalMonthlyExpenses = Accounting.totalBillsToPayOrCurrentAccount(1); // return total
                                                                                                 // expenses of the
                                                                                                 // ended month and sets
                                                                                                 // to cero the
                                                                                                 // billsToPay array
                    double totalMonthlyIncomes = Accounting.totalBillsToPayOrCurrentAccount(2); // return total incomes
                                                                                                // of the ended month
                                                                                                // and sets to cero the
